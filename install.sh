...
# 
# ===>> Default rate is [20]Mbps, if need change /etc/modprobe.d/tcp_nbbr.conf and reboot
# Create a file at /etc/modprobe.d/tcp_nbbr.conf 
#   options tcp_nbbr init_rate=50
#
# crontab -e
